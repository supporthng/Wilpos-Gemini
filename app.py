...
st.write("Carga tu factura (PDF o Imagen). El sistema autodetectará el proveedor (Álvarez & Sánchez, Isotex o CDC), el empaque, la moneda y calculará todo en pesos.")
...
with tab_individual:
    ...
    st.write("Sube el PDF o la imagen de tu factura. El sistema detectará el proveedor y cargará los ítems automáticamente.")
    ...
    if archivo_subido is not None:
        ...
        # 2. AUTODETECCIÓN DE ISOTEX
            ...
            st.success("🤖 ¡Proveedor detectado: Isotex Dominicana! Moneda: **USD** (Conversión automática a DOP).")
        ...
        # 3. AUTODETECCIÓN DE CENTRO DE DISTRIBUCION CRISTIAN (CDC)
            ...
            st.session_state.tipo_empaque_detectado = 0  # Por Empaques / Paquetes
            st.session_state.df_productos = pd.DataFrame([
            ...
            st.success("🤖 ¡Proveedor detectado: Centro de Distribucion Cristian (CDC)! Ítems de paquetes cargados con éxito[cite: 10].")
        else:
