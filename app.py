...
# ==========================================
    ...
    st.markdown("Sube varias facturas. El sistema consolidará automáticamente los productos repetidos en una sola fila y **te notificará en qué facturas se encuentra cada producto**.")
