        ...
        with st.spinner("Procesando factura con la versión de pago..."):
            try:
                ...
                prompt = (
                    ...
                    "REGLA CRÍTICA PARA CÓDIGOS DE BARRAS: Extrae rigurosamente el código de barras completo de cada producto (como EAN-13, UPC o códigos de proveedor). Trata el campo 'codigo' estrictamente como texto (string), PRESERVANDO ABSOLUTAMENTE TODOS LOS CEROS A LA IZQUIERDA y sin recortar ningún dígito. "
